	...
	<body>
			...
			<section class="top-bar-section">
				<ul class="left">
					...
					<li class="has-dropdown">
						...
						<ul class="dropdown">
							<li class="divider"></li>
							<li><a href="<?php echo url('/info_1_grade');?>">1年生授業</a></li>
							<li class="divider"></li>
							<li><a href="<?php echo url('/info_2_grade');?>">2年生授業</a></li>
							<li class="divider"></li>
							<li><a href="<?php echo url('/info_3_grade');?>">3年生授業</a></li>
							<li class="divider"></li>
						</ul>
					</li>
					<li class="divider"></li>
				...
				<ul class="right">
					<li class="divider"></li>
					<li><a href="#" data-reveal-id="Contribute">&nbsp;&nbsp;&nbsp;Contribute&nbsp;&nbsp;&nbsp;</a></li>
					<li class="divider"></li>
		...
		<div class="row">
			...
			<div class="large-3 columns">
				<ul class="stack button-group" id="faculty">
				</ul>
			</div>
			<!-- article -->
			<div class="large-9 columns">
		...
		<script>
			subject_select(1);
			var url = '<?php echo url('/info_2_grade');?>';
			append_faculty(2,url);
		</script>
